...
from tensorflow.keras.layers import Add, Dense, Dropout, Embedding, Layer, LayerNormalization, Multiply, Permute, Reshape
...
class Encoder:
    def __init__(self,
        ...
        self.multiply_constant = MultiplyConstant(d_model, name="%s/multiply" % scope)
        self.pos_encoding = PositionalEncoding(d_model,
                                               name="%s/positional_encoding" %
                                               scope)
...
class EncoderLayer:
    def __init__(self,
        ...
        self.add1 = Add(name="%s/add_1" % scope)
        self.add2 = Add(name="%s/add_2" % scope)
